...
import { generateRoomLayout, RoomStyles } from "../utils/roomBuilder";
...
export class InteriorScene extends Phaser.Scene {
    ...
    create(data) {
        ...
        if (imageLayer) {
        ...
        } else if (mapData || this.config.roomConfig) {
            const finalMapData =
                mapData ||
                generateRoomLayout(
                    this.config.roomConfig.width || 10,
                    this.config.roomConfig.height || 10,
                    RoomStyles[this.config.roomConfig.style] || RoomStyles.MODERN_GRAY,
                );
            ...
            layer.setDepth(0); // Floor/Walls layer at depth 0
        ...
        const interactionHandler = () => {
            ...
            if (this.isNearNPC) {
                ...
                getNPCResponse(this.activePortal.npcName, this.activePortal.role).then(aiMsg => {
