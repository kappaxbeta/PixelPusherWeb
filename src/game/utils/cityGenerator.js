...
const LAYOUTS = {
  ...
  crossRoadBorderX: [
    [359, 361, 361, 361, 361, 361, 361, 361, 361, 361, 360],
    [418, 420, 420, 420, 420, 420, 420, 420, 420, 420, 419],
  ],
  grass: [
    [144, 145, 144, 145],
    [203, 204, 203, 204],
...
export const generateCityGrid = (terrain, config) => {
  ...
  if (!config || !Array.isArray(config)) {
    console.warn(
      "[cityGenerator] No config provided, using single default block.",
    );
    config = [[TStyle.BLOCK]];
  }

  console.log(
    `[cityGenerator] Starting modular grid generation: ${config.length} rows...`,
  );
