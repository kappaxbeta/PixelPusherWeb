...
export class Building extends Phaser.GameObjects.Container {
    ...
    build() {
        ...
        debugRects.forEach((dr) => {
            ...
            debugRect.setVisible(this.debug || this.scene.showDebug || false);
            this.add(debugRect);
            this.debugShapes.push(debugRect);
        });
    ...
    setupDebug() {
        ...
        const isVisible = this.debug || this.scene.showDebug || false;
        ...
        advancedHandle.setVisible(isVisible);
        ...
        advancedText.setVisible(isVisible);
